...
updatePassword = (email, firstName, frontBaseUrl, code) => {
  sendEmail({
    to: email,
    ...
    html:
      `
        <div style="max-width: 500px; margin: 50px auto; background-color: #f8fafc; padding: 30px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); font-family: 'Arial', sans-serif; color: #333333;">
            ...
            <p style="font-size: 18px; line-height: 1.6; margin-bottom: 25px; text-align: center;">Haz solicitado actualizar la contraseña. Para actualizarla, haga click en el siguiente enlace:</p>
